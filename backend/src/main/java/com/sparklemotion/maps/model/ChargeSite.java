...
public class ChargeSite {
  ...
  // In degrees around the world, aka lat/lng. Roughly 1km (multiply by 111.139 for km).
  public static final double MAX_OBFUSCATED_RADIUS = 0.01;
  ...
  public void generateObfuscation() {
    ...
    // The obfuscated geolocation is at most MAX_OBFUSCATED_RADIUS * 111.139km away.
    double distance = random.nextDouble(MAX_OBFUSCATED_RADIUS);
